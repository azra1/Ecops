<%-- 
    Document   : policecomplaintdetailjsp
    Created on : Mar 22, 2016, 11:25:53 AM
    Author     : Azra
--%>
       ...
       %>
        <div id="policeinner">
            <div id="policetop"><img src="images/images_1.png">
                <div id="policehead"><center><h1><u><i>VIEW COMPLAINT DETAIL</i></u></h1></center>
            ...
            while(rs.next())
            {
                ...
                <form action="caseform.jsp">
                    <table border="2%"cellspacing="10%" cellpadding="20%" width="50%">
                        ...
                        <tr><td><button><a href="policeshowcomplaint.jsp">BACK</a></button></td><td><input type="submit" value="Case Status"></td></tr>
                    </table>
