<%-- 
    Document   : update
    Created on : Mar 18, 2016, 1:48:11 PM
    Author     : Azra
--%>
...
<html>
    ...
    <body>
     ...
     else 
     {
       ...
       String image_name="",cname="",gender="",height="",weight="",policestatn="",crimelvl="",crime="",status="",tid="";
       while (itr.hasNext()) 
       {
           ...
           if (item.isFormField())   //checking if its normal field then we read as normal. no need to store in disc
            ...
            stSetLimit.execute(querySetLimit);     
                 String q="update criminaltable set Image_name=?,Name=?,Gender=?,Height=?,Weight=?,Policestation=?,Crimelevel=?,Crime=?,Status=? where CriminalId=?";
                ...
                rd.include(request, response);
                       ...
                       {
                       msg="Criminal Record not Updated !!";
                request.setAttribute("message",msg);
                 RequestDispatcher rd=request.getRequestDispatcher("editcriminal.jsp");
                rd.include(request, response);
                       }
