<%-- 
    ...
    Created on : Mar 18, 2016, 12:58:23 PM
    Author     : Azra
--%>
...
<html>
       ...
       %>
        <div id="admininner">
            <div id="admintop"><img src="images/images_1.png">
                <div id="adminhead"><center><h1><u><i>EDIT CRIMINALS RECORDS</i></u></h1></center>
 ...
 <tr><th bgcolor="grey"color="black">Criminal-Id</th><th bgcolor="grey" color="white">Image</th><th bgcolor="grey" color="white">Name</th><th bgcolor="grey" color="white">EDIT</th></tr>
...
<td><%=rs.getString(3)%></td>
 ...
 <td><button><a href="editablecriminal.jsp?tid=<%=rs.getInt(1)%>">Edit</a></button></td>
</tr> 
