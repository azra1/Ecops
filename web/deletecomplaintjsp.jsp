<%-- 
    Document   : deletecomplaintjsp
    Created on : Mar 9, 2016, 1:45:06 PM
    Author     : Azra
--%>
       ...
       String n=(String)session.getAttribute("nm");
         ...
         try {
           ...
           Connection con=connect.Connectdb.getDb();
            String q="delete from complainttable where id=?";
            ...
            if(x>0)
            {
                ...
                RequestDispatcher rd=request.getRequestDispatcher("deletecomplaint.jsp");
