<%-- 
    ...
    Created on : Mar 8, 2016, 8:19:59 PM
    Author     : Azra
--%>
...
<html>
       ...
       %>
        <div id="admininner">
            <div id="admintop"><img src="images/images_1.png">
                <div id="adminhead"><center><h1><u><i>VIEW COMPLAINT</i></u></h1></center>
            ...
            <div class="right">
                <div id="t2" align="center"><br>
                            <br><table cellspacing="2%" cellpadding="3%" align="center" border="2%">
                                <tr><th bgcolor="grey"color="black">Id</th><th bgcolor="grey" color="white">Email</th><th bgcolor="grey" color="white">Police Station Name</th><th bgcolor="grey" color="white">Subject</th><th bgcolor="grey" color="white">Date</th><th bgcolor="grey" color="white">Status</th><th bgcolor="grey" color="white">Details</th></tr>
    ...
    else
    {
        ...
        int start=peg*5-5;
        q="select * from complainttable limit "+start+","+5;
    }
            ...
            while(rs.next())
            {
                ...
                <tr color="black">
                    ...
                    <td><button><a href="complaintdetailjsp.jsp?tid=<%=rs.getInt(1)%>">Details</a></button></td>
                </tr>
   ...
   //    }catch(Exception e){System.out.println(e);}
    ...
    <a href="showcomplaint.jsp?page=<%=i%>"><%=i%></a>
